...
<div id="sidebar"><a href="{{url('/home')}}" class="visible-phone"><i class="fa fa-home icon-white"></i> Home</a>
    <ul>
        ...
        @if($user->role == 'admin')
            ...
            <li class="submenu"> <a href="{{url('/home')}}"><i class="fa fa-dashboard icon-white"></i> <span>Dashboard</span></a>
                <ul>
            ...
            <li><a href="{{url('/admin/attendance')}}" target="_blank"><i class="fa fa-users icon-white"></i> <span>Attendance</span></a> </li>
            ...
            <li class="active"><a href="{{url('/admin/users')}}"><i class="fa fa-users icon-white"></i> <span>Users</span></a> </li>
            ...
            <li><a href="{{url('/admin/logs')}}"><i class="fa fa-list icon-white"></i> <span>Logs</span></a></li>
        @else
