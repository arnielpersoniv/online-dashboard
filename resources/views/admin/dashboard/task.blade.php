...
<div class="container-fluid">
    <div class="row-fluid">
        ...
        <div class="widget-box" id="div_daily">
            ...
            <h5 class="h5-label">DAILY ACTIVITIES TRACKER</h5>
    ...
    <div class="row-fluid">
        <div class="widget-box" id="div_weekly">
            ...
            <h5 class="h5-label">WEEKLY ACTIVITIES TRACKER - <b id="label_weekly"></b></h5>
    ...
    <div class="row-fluid">
        <div class="widget-box" id="div_monthly">
            ...
            <h5 class="h5-label">MONTHLY ACTIVITIES TRACKER</h5>
    ...
    <div class="row-fluid">
        <div class="widget-box" id="div_yearly">
            <div class="widget-title">
                <span class="icon"><i class="icon-th"></i></span>
                <h5 id="txt_yearly"></h5>
                <div class="buttons"><a href="#" class="btn btn-mini btn-success btn_hide" id="4"><i class="fa fa-eye"></i> Hide/Show</a></div>
            </div>
            <h5 class="h5-label">YTD ACTIVITIES TRACKER</h5>
...
@endsection
@section('js')
<script src="{{asset('scripts/admin/dashboard/task.js')}}"></script>
<script src="{{asset('scripts/admin/dashboard/taskTableTotal.js')}}"></script>
@endsection