                    ...
                    <div class="span4">
                        <div class="widget-box">
                            ...
                            <div class="widget-content nopadding">
                                <form class="form-horizontal" method="post" id="form_category" novalidate="novalidate">
                                    @csrf
                                    <input type="hidden" id="edit_id" name="category_id">
                                    <div class="control-group">
                                        <label class="control-label required">Name of Category</label>
                                        <div class="controls">
                                            <input type="text" class="span11" placeholder="Name of Category" name="name" id="category_name" autocomplete="off"/>
                                        </div>
                                    </div>
...
@endsection
@section('js')
<script src="{{asset('scripts/admin/category.js')}}"></script>
@endsection